...
The prepared release version is `1.0.2`.
...
/tmp/robyn-mcp-release-check/bin/python -m pip install robyn robyn-mcp==1.0.2
...
- Confirm `pip install robyn-mcp==1.0.2` works in a clean environment.
